...
<html lang="en">
  ...
  <script>
		...
		<div class="row">
			...
			<form:form id="invoiceForm" class="form-horizontal" method="post" action="/AccountmateWS/saveSalesInvoice">
					<div class="form-group">
						...
						<div class="bfh-datepicker col-md-offset-1 col-md-2" id="taxinvoicedate" data-name="taxinvoicedate" data-format="y-m-d" data-date="2014-04-04" >
						</div>
						<div class="bfh-datepicker col-md-offset-1 col-md-2" id="retailinvoicedate" data-name="retailinvoicedate" data-format="y-m-d" data-date="2014-04-04" >
						</div>
					</div>
					<div class="form-group">
					...
					<table id="invoice-table" class="table">
						...
						<tbody>
							<tr id="row0">
								...
								<td><select id="p0" name="items[0].productID" class="form-control" onChange="updateQuantity(0);updateDLP(0);">
									<c:forEach var="product" items="${products}">
										<option value="${product.productID}">${product.productName}</option>
									</c:forEach>
									</select>
								</td>
								<td><input id="qty0" type="text" name="items[0].quantity"  data-toggle="tooltip" data-placement="left" title="Quantity Available = ${products[0].productBalance}" class="form-control text-right" value="0" onkeyup="checkLimit(this,'${products[0].productBalance}');rowCalc(0);"/>
								</td>
								...
								<td>
									<input id="pcV0" type="text" class="form-control text-right" value="0.00" data-toggle="tooltip" data-placement="left" onkeyup="rowCalc2(0);" name="items[0].priceWithVat" title="Current DLP = Rs. ${products[0].dealerPrice}"/>
								</td>
					...
					<div>
						<div class="form-group">
							<div class="pull-right">
								<button id="savebutton" type="submit" class="btn btn-primary btn-lg">Save</button>
	...
	<script>
		...
		var taxinvoicedate = document.getElementById('taxinvoicedate');
		taxinvoicedate.setAttribute('data-date',getCurrentDate());
		taxinvoicedate.setAttribute('data-min','${latesttaxdate}');
		
		var retailinvoicedate = document.getElementById('retailinvoicedate');	
		retailinvoicedate.setAttribute('data-date',getCurrentDate());
		retailinvoicedate.setAttribute('data-min','${latestretaildate}');
	</script>
	<script>
