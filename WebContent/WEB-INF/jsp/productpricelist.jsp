...
<html lang="en">
  ...
  <body>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h2 class="text-left col-md-6">Price List</h2>
			</div>
		</div>
	</div>
	<!-- Search Form
		...
		<div class="well">
			<div class="row">
				<div class="form-group">
					<label for="name" class="col-md-1">Category</label>
					<div class="col-md-3">
					...
					<tbody>
						...
						<tr id="row${product.productID}">
							...
							<td class="text-right col-md-2" data-actual="${product.costPrice}">
    							...
    							<input type="text" class="edit-input form-control text-right cp" value="${product.costPrice}"/>						
							</td>
							<td class="text-right col-md-2" data-actual="${product.dealerPrice}">
    							...
    							<input type="text" class="edit-input form-control text-right dp" value="${product.dealerPrice}"/>						
							</td>
							<td class="text-right col-md-2" data-actual="${product.marketPrice}">
    							...
    							<input type="text" class="edit-input form-control text-right mrp" value="${product.marketPrice}"/>						
							</td>
						</tr>
						</c:forEach>
					</tbody>
    ...
    $(document).ready(function() {
        $('span.edit').click(function () {
        	var dad = $(this).parent();
            dad.find('span').hide();
           	dad.find('input[type="text"]').css("display", "block");
           	dad.find('input[type="text"]').focus();
        });

        $('input[type=text].edit-input').focusout(function() {
            var dad = $(this).parent();
            var productid = dad.parent().children().first().html();
