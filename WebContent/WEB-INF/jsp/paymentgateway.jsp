<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
    <form class="form-horizontal" id="clientForm" action="/AccountmateWS/savePaymentDetails" method="post">
					...
					<div class="form-group">
						<label for="name" class="col-md-2">Date of Payment </label>
						<div class="col-md-4">
							<div>
								<div id="paymentdate" class="form-control" style="cursor: pointer;margin-bottom:10px;">
					...
					<div class="form-group" id="billWiseCheckBox">
						<div class="col-md-offset-2 col-md-4">
							<input type="checkbox" id="billWisePayment" onclick="updateInvoiceList();" name="billWisePayment"/> Bill Wise Payment
						</div>
					</div>
					<div id="invoice-dropdown">
						<%@include file="paymentgatewayinvoicedropdown.jsp" %>
 					</div>
 					<hr/>
 					<div id="invoice-tables">
 						<%@include file="paymentgatewaytables.jsp" %>
					</div>
					<div class="form-group">
						<label for="pay" class="col-md-2">Pay</label>
						<div class="col-md-4">
					...
					<div id="paymentbutton" class="form-group">
