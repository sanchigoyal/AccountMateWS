...
<html lang="en">
  ...
  <body>
		...
		<div class="row">
			...
			<div class="col-md-4 col-md-offset-8">
				<div id="daterange" class="form-control" style="cursor: pointer;margin-bottom:10px;">
	                ...
	                <span></span>
	                <form id="dateChange" method="post" action="/AccountmateWS/showPurchaseBook">
							...
							<table class="table table-striped">
								<thead>
									<tr class="well">
										<td class="col-md-2 text-center">Date</td>
										<td class="col-md-3 text-center">Description</td>
										<td class="col-md-1 text-center">Bill Number</td>
										<td class="col-md-2 text-right">Amount</td>
										<td class="col-md-4 text-center">Payment Refernce</td>
									</tr>
								</thead>
								<tbody>
			...
			<!----Payment Modal--->
			<div class="modal fade" id="paymentModel" tabinex="-1" role="dialog" aria-hidden="true">
				<div class="modal-dialog large">
					<div id="invoice-content" class="modal-content">
					...
					<div class="modal-content">
							...
							<div class="modal-footer">
								<form:form class="form-inline" id="invoicedeleteform" method="post" action="/AccountmateWS/deleteInvoice">
									...
									<input type="hidden" id="redirectpage" name="redirectpage" value="invoice/purchasebook"/>
    ...
    function updatePaymentModal(invoiceid){
		var data = 'invoiceid='
			+ encodeURIComponent(invoiceid);
		$.ajax({
			url : "/AccountmateWS/getInvoicePaymentDetails",
			data : data,
			type : "GET",
			...
			success : function(data) {
				...
				$("#billWisePayment").prop('checked', true);
