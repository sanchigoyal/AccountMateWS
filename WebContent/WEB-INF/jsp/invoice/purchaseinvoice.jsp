				...
				<form:form id="invoiceForm" class="form-horizontal" action="/AccountmateWS/savePurchaseInvoice">
					<div class="form-group required">
						...
						<div class="col-md-3 pull-right">
							<div>
								<div id="invoicedate" class="form-control" style="cursor: pointer;">
						...
						<table class="table table-bordered table-striped" id="invoice-table">
							<thead>
								<tr class="well">
									...
									<th class="text-center">Update CP</th>
								</tr>
							</thead>
							<tbody>
								<tr id="row0">
									...
									<td>
										<select id="p0" name="items[0].productID" class="form-control productname" onChange="updateQuantity(0);">
									...
									<td>
										<input id="qty0" type="text" name="items[0].quantity"  data-toggle="tooltip" data-placement="left" title="Quantity Available = ${products[0].productBalance}" class="form-control text-right quantity" value="0" onkeyup="rowCalc(0);"/>
									</td>
									<td>
									...
									<td>
										<input id="pcV0" type="text" class="form-control text-right price" value="0.00" onkeyup="rowCalc2(0);" name="items[0].priceWithVat"/>
									</td>
									<td>
									...
									<td style="text-align: center; vertical-align: middle;">
										<input type="checkbox" id="updatecp0"  class="text-center" name="items[0].updateCP"/>
									</td>
								</tr>
							</tbody>
						</table>
        ...
        fields: {
        	billNumber: {
                ...
                validators: {
                    ...
                    regexp: {
                        regexp: /^[a-zA-Z0-9_]+$/,
                        message: 'The invoice number can consist of alphabets,digits(0-9) and underscore'
                    }
                }
            },
            shippedTo: {
...
$(document).ready(function() {         
     var cb = function(start, end, label) {
         $('#invoicedate span').html(start.format('MMMM D, YYYY'));
         $('#invoicedate input').val(start.format('YYYY-MM-DD'));
       };      
     var optionSet = {
   	         showDropdowns: true,
      ...
      $('#invoicedate span').html(moment().format('MMMM D, YYYY'));
      $('#invoicedate input').val(moment().format('YYYY-MM-DD'));
      $('#invoicedate').daterangepicker(optionSet, cb);
});
